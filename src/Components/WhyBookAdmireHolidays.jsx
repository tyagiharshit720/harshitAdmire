      ...
      <div className="flex-1 max-w-md">
        <div className="space-y-6">
          <FeatureItem 
            ...
            text="Wide range of exclusive deals with resorts."
          />
          ...
          <FeatureItem 
            ...
            text="Detailed and clear package info."
          />
          ...
          <FeatureItem 
            ...
            text="Local support for hassle-free travel."
          />
          ...
          <FeatureItem 
            ...
            text="Quick & easy booking process."
          />
        </div>
        
        <div className="mt-8 flex items-center gap-3 border-l-4 border-yellow-600 pl-4 text-yellow-700 font-semibold">
...
const FeatureItem = ({ icon, text }) => {
  return (
    <div className="flex items-center gap-4 p-4 border rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300" style={{ minHeight: "72px" }}>
...
export default WhyBookAdmireHolidays;